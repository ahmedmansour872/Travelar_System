...
namespace Travelar_System
{
    public partial class Form7 : Form
    {
        ...
        private void Form7_Load(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter sda = new SqlDataAdapter("Select * FROM Custom_tour where [Travels ID]= '" + id + "'", con);
            ...
            foreach (DataRow item in dt.Rows)
            {
                ...
                dataGridView1.Rows[n].Cells[1].Value = item["Description"];
                dataGridView1.Rows[n].Cells[2].Value = item["Travels ID"];
                dataGridView1.Rows[n].Cells[3].Value = item["Number of individuals"];
                dataGridView1.Rows[n].Cells[4].Value = item["Individual price"];
                dataGridView1.Rows[n].Cells[5].Value = item["total price"];
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (con.State == System.Data.ConnectionState.Open)
                {
                    ...
                    string q = "insert into traveler_custom(fullname,phone)values('" + username.Text.ToString() + "','" + x + "')";
